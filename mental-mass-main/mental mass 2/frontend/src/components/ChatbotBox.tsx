...
const ChatbotBox = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Use actual API response, not a default fallback
      ...
      let errorText = "I encountered an issue processing your message. Please try again.";
      if (error instanceof Error && error.message.includes("No reply")) {
        errorText = "The server didn't provide a response. Please try again.";
      }
